  ...
  return (
    <ScreenWrapper>
         <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 1 }}>
                ...
                <Text style={{ color: 'white', flex: 1, textAlign: 'center', fontSize: 25, fontWeight: '700' }}>Language</Text>
              </View>
              {/*  */}
              ...
              <Text style={{color:'white',fontSize:20,fontWeight:'bold',marginTop:hp(3)}}>Choose preferred language</Text>
